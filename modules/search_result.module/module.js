function limitText (string = '', limit = 0) {  
...
var hsResultsPage = function(_resultsClass) {
    function buildResultsPage(_instance) {
      var resultTemplate = _instance.querySelector(
        ...
        resultsSection = _instance.querySelector('.search-result__listing'),
      ...
      function addResult(title, url, description, featuredImage) {
        ...
        function isFeaturedImageEnabled() {
          if (
            newResult.querySelector('.post__image')
          ) {
            return true;
          }
        }
        newResult.querySelector('.post__title>a').innerHTML = title;
        newResult.querySelector('.post__title>a').href = url;
        newResult.querySelector('.post__title>a, .post__image').href = url;
        
        let trimDescription = limitText(description, 150);

        newResult.querySelector(
          '.post__description'
        ).innerHTML = trimDescription+'...';
